...
def default_site_config(apps, schema_editor):
    ...
    Config.objects.bulk_create(
        [
            Config(key="school_name", value="Webnet Infotech Computer Institute"),
            Config(key="school_slogan", value="Webnet Infotech Computer Institute"),
            Config(key="school_address", value="Beside MCC Bank, near Post Office, Bahalda, Odisha 757046"),
        ]
    )
